...
<body>
    ...
    <div class="container">
        <div class = "add-to-db-wrapper text-center text-lg-right">
            <a class = "add-to-db-btn" href = "add-category.php">Add Category</a>
        </div>
            ...
            <div class = "row justify-content-center align-items-center">
                <table class = "backend-table">
                    <tr>
                        ...
                        <?php 
                        $selectcategories = "SELECT id, name FROM categories";
                        $resultcategories = $mysqli->query($selectcategories);
                    ?>
                        <?php 
